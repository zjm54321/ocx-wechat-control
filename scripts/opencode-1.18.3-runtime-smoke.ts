...
try {
	...
	assert(healthResponse.ok && health.packageVersion === "0.2.3" && health.protocolVersion === 1 && health.schemaVersion === 6 && health.adapter === "Ready", "worker health metadata mismatch")
