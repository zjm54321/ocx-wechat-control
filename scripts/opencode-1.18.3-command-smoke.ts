...
const metadata = { packageVersion: "0.2.6", protocolVersion: 1, capabilities: ["v2-callbacks", "async-prompt-admission", "native-question-permission", "legacy-inject-disabled", "dynamic-active-aliases", "logical-wechat-reply-identity", "authenticated-stale-binding-reaping"], workerPid: process.pid, workerEntrypoint, adapterCommand: adapter, adapterProvenance: { kind: "fixed-local-dependency", package: "weixin-mcp", version: "1.7.7", entrypoint: adapter[1] }, schemaVersion: 8 }
