...
try {
	...
	assert(healthResponse.ok && health.packageVersion === "0.2.6" && health.protocolVersion === 1 && health.schemaVersion === 8 && health.adapter === "Ready", "worker health metadata mismatch")
