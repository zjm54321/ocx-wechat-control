...
try {
	...
	assert(healthResponse.ok && health.packageVersion === "0.2.5" && health.protocolVersion === 1 && health.schemaVersion === 7 && health.adapter === "Ready", "worker health metadata mismatch")
