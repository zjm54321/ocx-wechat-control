export const WORKER_PACKAGE_VERSION = "0.2.6"
export const WORKER_PROTOCOL_VERSION = 1
export const WORKER_SCHEMA_VERSION = 8
export const WORKER_CAPABILITIES = ["v2-callbacks", "async-prompt-admission", "native-question-permission", "legacy-inject-disabled", "dynamic-active-aliases", "logical-wechat-reply-identity", "authenticated-stale-binding-reaping"] as const
